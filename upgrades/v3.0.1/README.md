...
* Chain upgrade point: `Apr 3rd 2024, 15:30 UTC` approximately at height `8,788,500`;
* Go version: `v1.20`
...
The upgrade will take place approximately at `15:30 UTC` approximately at height `8788500`;
...
```shell
ERR UPGRADE "v3.0.1" NEEDED at height: 8788500: upgrade to v3.0.1 and applying upgrade "v3.0.1" at height:8788500
```
...
> neutrond start --unsafe-skip-upgrade 8788500
