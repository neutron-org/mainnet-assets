...
This document describes the steps for validators and full node operators, to upgrade successfully to the Neutron v9.1.2 release. For more details on the release, please see the [release notes](https://github.com/neutron-org/neutron/releases/tag/v9.1.2).
...
The Neutron mainnet network, `neutron-1`, will run [Neutron v9.1.2](https://github.com/neutron-org/neutron/releases/tag/v9.1.2). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
### Download the updated Neutron binary of v9.1.2 for your platform and OS

* [The binary](https://github.com/neutron-org/neutron/releases/tag/v9.1.2)

### Check the new neutron version, verify the latest commit hash
```shell
   $ neutrond version --long
    build_tags: netgo,ledger
    commit: 5f452a1b7d47a7a5716abe730757e6d9a7c03a2d
    cosmos_sdk_version: v0.50.15-neutron
...
### Or check checksum of the binary if you decided to [download it](https://github.com/neutron-org/neutron/releases/tag/v9.1.2)
...
- Use a statically built Neutrond binary from an official Neutron release: [https://github.com/neutron-org/neutron/releases/tag/v9.1.2](https://github.com/neutron-org/neutron/releases/tag/v9.1.2)
...
```shell
ERR UPGRADE "v9.1.2" NEEDED at height: 46170000: upgrade to v9.1.2 and applying upgrade "v9.1.2" at height: 46170000
```

Stop the node, and switch the binary to **Neutron v9.1.2** and re-start by `neutrond start`.
...
create a Cosmovisor folder inside `$NEUTRON_HOME` and move Neutron v9.1.1 into `$NEUTRON_HOME/cosmovisor/genesis/bin`
...
Download **Neutron v9.1.2** [binary](https://github.com/neutron-org/neutron/releases/tag/v9.1.2), and move neutrond v9.1.2 to `$NEUTRON_HOME/cosmovisor/upgrades/v9.1.2/bin`

```shell
mkdir -p  $NEUTRON_HOME/cosmovisor/upgrades/v9.1.2/bin
cp $(which neutrond) $NEUTRON_HOME/cosmovisor/upgrades/v9.1.2/bin
```
...
Steps to skip this upgrade proposal are simply to resume the neutron-1 network with the (downgraded) v9.1.1 binary using the following command:

> neutrond start --unsafe-skip-upgrade 46170000
