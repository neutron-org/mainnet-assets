...
- Chain upgrade point: `Nov 5th 2025, 15:00 UTC (approximately)`, at height `39414000`;
- Go version: `v1.23.4`
...
The upgrade will take place approximately on Nov 5th at approximately `15:00 UTC` at height `39414000`;
...
```shell
ERR UPGRADE "v8.2.0" NEEDED at height: 39414000: upgrade to v8.2.0 and applying upgrade "v8.2.0" at height: 39414000
```
...
> neutrond start --unsafe-skip-upgrade 39414000
