...
* Chain upgrade height: `14638000`. Exact upgrade time can be checked [here](https://www.mintscan.io/neutron/block/14638000).
...
- Use a statically built Neutrond binary from an official Neutron release: [https://github.com/neutron-org/neutron/releases/tag/v4.2.3](https://github.com/neutron-org/neutron/releases/tag/v4.2.3)
