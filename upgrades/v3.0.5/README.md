...
- Chain upgrade point: `May 22nd 2024, 13:30 UTC` approximately at height `10490000`;
- Go version: `v1.21`
...
The upgrade will take place approximately on May 22nd at `13:30 UTC` approximately at height `10490000`;
...
```shell
ERR UPGRADE "v3.0.5" NEEDED at height: 10490000: upgrade to v3.0.5 and applying upgrade "v3.0.5" at height: 10490000
```
...
> neutrond start --unsafe-skip-upgrade 10490000
