...
The upgrade will take place approximately on April 15th at approximately `14:00 UTC` at height `53740000`;
...
```shell
ERR UPGRADE "v10.3.0" NEEDED at height: 53740000: upgrade to v10.3.0 and applying upgrade "v10.3.0" at height: 53740000
```
...
> neutrond start --unsafe-skip-upgrade 53740000
