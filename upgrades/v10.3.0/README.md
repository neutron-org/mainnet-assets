...
- Chain upgrade point: `April 17th 2026, 14:00 UTC (approximately)`, at height `53925000`;
- Go version: `v1.24.10`
...
The upgrade will take place approximately on April 17th at approximately `14:00 UTC` at height `53925000`;
...
```shell
ERR UPGRADE "v10.3.0" NEEDED at height: 53925000: upgrade to v10.3.0 and applying upgrade "v10.3.0" at height: 53925000
```
...
> neutrond start --unsafe-skip-upgrade 53925000
