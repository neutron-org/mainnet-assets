...
This document describes the steps for validators and full node operators, to upgrade successfully to the Neutron v10.2.0 release. For more details on the release, please see the [release notes](https://github.com/neutron-org/neutron/releases/tag/v10.2.0).
...
The Neutron mainnet network, `neutron-1`, is currently running [Neutron v10.1.0](https://github.com/neutron-org/neutron/releases/tag/v10.1.0). We anticipate that operators who are running on v10.1.0, will be able to upgrade successfully. Validators are expected to ensure that their systems are up-to-date and capable of performing the upgrade. This includes running the correct binary, or if building from source, building with go `1.24`.

### Target runtime

The Neutron mainnet network, `neutron-1`, will run [Neutron v10.2.0](https://github.com/neutron-org/neutron/releases/tag/v10.2.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
## Create the updated Neutron binary of v10.2.0
...
### Or check checksum of the binary if you decided to [download it](https://github.com/neutron-org/neutron/releases/tag/v10.2.0)
...
- Use a statically built Neutrond binary from an official Neutron release: [https://github.com/neutron-org/neutron/releases/tag/v10.2.0](https://github.com/neutron-org/neutron/releases/tag/v10.2.0)
...
Make sure Neutron v10.2.0 is installed by either downloading a [compatible binary](https://github.com/neutron-org/neutron/releases/tag/v10.2.0), or building from source. Building from source requires **Golang 1.24.x**.
...
create a Cosmovisor folder inside `$NEUTRON_HOME` and move Neutron v10.1.0 into `$NEUTRON_HOME/cosmovisor/genesis/bin`
...
build **Neutron v10.2.0**, and move neutrond v10.2.0 to `$NEUTRON_HOME/cosmovisor/upgrades/v10.2.0/bin`

```shell
mkdir -p  $NEUTRON_HOME/cosmovisor/upgrades/v10.2.0/bin
cp $(which neutrond) $NEUTRON_HOME/cosmovisor/upgrades/v10.2.0/bin
```
