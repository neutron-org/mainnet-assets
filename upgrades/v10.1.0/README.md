...
- Chain upgrade point: `March 9th 2026, 15:00 UTC (approximately)`, at height `TBD`;
- Go version: `v1.24.10`
...
The upgrade will take place approximately on March 9th at approximately `15:00 UTC` at height `TBD`;
...
```shell
ERR UPGRADE "v10.1.0" NEEDED at height: TBD: upgrade to v10.1.0 and applying upgrade "v10.1.0" at height: TBD
```
...
> neutrond start --unsafe-skip-upgrade TBD
