...
- Chain upgrade point: `Dec 10th 2025, 15:00 UTC (approximately)`, at height `40700000`;
- Go version: `v1.23.4`
...
The upgrade will take place approximately on Dec 10th at approximately `15:00 UTC` at height `40700000`;
...
```shell
ERR UPGRADE "v9.1.0" NEEDED at height: 40700000: upgrade to v9.1.0 and applying upgrade "v9.1.0" at height: 40700000
```
...
> neutrond start --unsafe-skip-upgrade 40700000
