# Upgrade from Neutron v4.2.0 to v4.2.1

> ## This is an important security update. IT IS CONSENSUS BREAKING UPGRADE! Please apply the fix only at height 13711950.

### Release Details
* https://github.com/neutron-org/neutron/releases/tag/v4.2.1
* Chain upgrade height: `13711950`. Exact upgrade time can be checked [here](https://www.mintscan.io/neutron/block/13711950).
...
# Setup Cosmovisor
## Create the updated Neutron binary of v4.2.1
...
```shell
   ...
   version: 4.2.1
   commit: ac620c19ae88c9d8697190664f709931f33b007d
   ...
```
...
2ac6a50e5a85865214ccfb8a742ad56875279b7f45fa7e45b296243c15bf9fc3  neutrond-linux-amd64
```
...
## Copy the new neutron (v4.2.1) binary to cosmovisor current directory
```shell
